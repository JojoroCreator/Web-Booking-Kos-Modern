...
for (let i = today.getDate(); i <= lastDayOfMonth; i++) {
    ...
    datesElement.innerHTML += `
        <div class="swiper-slide !w-fit py-[2px]">
            <label class="relative flex flex-col items-center justify-center w-fit rounded-3xl p-[14px_20px] gap-3 bg-white border border-white hover:border-[#8A2BEF] has-[:checked]:ring-2 has-[:checked]:ring-[#8A2BEF] transition-all duration-300 cursor-pointer">
