...
@section('content')
    <div id="Background"
        ...
        style="background: linear-gradient(180deg, #8A2BEF 0%, #5D12AB 100%);"></div>
    ...
    <div id="Header" class="relative flex items-center justify-between gap-2 px-5 mt-[18px]">
        <div class="flex flex-col gap-[6px]">
            <h1 class="font-bold text-[32px] leading-[48px] text-white">Search Result</h1>
            <p class="text-white opacity-80">Tersedia {{ $boardingHouses->count() }} Kos</p>
        </div>
    </div>
    ...
    <section id="Result" class=" relative flex flex-col gap-4 px-5 mt-5 mb-9">
        @foreach ($boardingHouses as $boardingHouse)
            <a href="{{ route('boarding-house.show', $boardingHouse->slug) }}" class="card">
                <div class="flex rounded-[30px] border border-[#F1F2F6] p-4 gap-4 bg-white transition-all duration-300"
                    ...
                    <div class="flex flex-col gap-3 w-full">
                        ...
                        <p class="font-semibold text-lg" style="color: #8A2BEF;">
